...
if __name__ == "__main__":
    ...
    background = pygame.image.load('../StreetPyghter/src/../res/Background/MenuScreen.png').convert()
    sprite_list = SpriteSheetLoader('../StreetPyghter/src/../res/Char/Ken/Ken.png', 60, 60).getSpriteList()
    gameobj = GameObjectWithHitBox('../StreetPyghter/src/../res/Char/Ken/Ken.png', 60, 60, Point(32,130))
