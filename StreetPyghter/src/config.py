...
class  Alphabet(object):
    ...
    def __new__(cls): 
        ...
        if cls.instance is None:
            cls.instance = object.__new__(cls)
            cls.sprites = SpriteSheetLoader('../StreetPyghter/src/../res/Ascii.png', 16, 16, True).getSpriteList()
        return cls.instance
...
class SoundPlayer:
    ...
    def play_music(self, file):
        if file.find('../StreetPyghter/src/../res/sound/music/') < 0:
            file = '../StreetPyghter/src/../res/sound/music/'+file
        try:
    ...
    def play_sound(self, file):
        if file.find('../StreetPyghter/src/../res/sound/') < 0:
            file = '../StreetPyghter/src/../res/sound/'+file
...
if __name__ == "__main__":
    c = OptionConfig('../StreetPyghter/src/../res/config.txt')
    print('done')